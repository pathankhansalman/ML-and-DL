# This is a code that recommends movies to an user
# Credits:
...
def parseInput(line):
    ...
    return Row(userID = int(fields[0]), movieID = int(fields[1]),
...
if __name__ == "__main__":
    ...
    topRecommendations = recommendations.sort(recommendations.prediction.
                                              desc()).take(20)
